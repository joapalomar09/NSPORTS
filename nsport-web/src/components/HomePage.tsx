    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 border-b ${scrolled ? "bg-[#121212]/95 backdrop-blur-md border-[#2B2B2B]" : "bg-transparent border-transparent"}`}>
      <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <img src="/images/elite-sport-logo.png" alt="Elite Sport" className="h-10 w-auto" />
  ...
  return (
    <header className="relative w-full h-[100dvh] flex items-center justify-center overflow-hidden">
      <div 
        ...
        style={{ backgroundImage: "url(/images/agency-hero.jpg)", backgroundPosition: "center 20%" }}
      />
    ...
    <section id="alianza" className="py-24 bg-[#121212] border-y border-[#2B2B2B] scroll-mt-24">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14 mb-10">
          <div className="flex items-center gap-2">
            <img src="/images/elite-sport-logo.png" alt="NSPORT" className="h-[2.34375rem] w-auto" />
          </div>

          <span className="font-bebas md:text-6xl text-[#C6A25D] font-normal text-xl">&amp;</span>

          <div className="flex items-center gap-4">
            <img src="/images/bta-logo-white.png" alt="BTA - Behind the Athlete" className="h-[2.34375rem] w-auto" />
            <a
...
const Jugadores = () => {
  ...
  const players = [
    { name: "Ramiro Tulián", age: 18, position: "DEL", club: "Belgrano", image: "/images/ramiro-tulian-2.jpg" },
    { name: "Lautaro Barraza", age: 20, position: "DEL", club: "Cancún FC", image: "/images/lautaro-barraza.jpg" },
    { name: "Pedro Gutiérrez", age: 20, position: "DEF", club: "Belgrano", image: "/images/pedro-gutierrez.jpg" },
    { name: "Bautista Torres", age: 16, position: "DEL", club: "Banfield", image: "/images/bautista-torres.jpg" },
    { name: "Francisco Mansilla", age: 14, position: "DEL", club: "Belgrano", image: "/images/francisco-mansilla.jpg" },
    { name: "Matías Macagno", age: 14, position: "DEL", club: "Talleres", image: "/images/matias-macagno.jpg" },
    { name: "Benicio Zapata", age: 14, position: "MED", club: "Talleres", image: "/images/benicio-zapata.jpg" },
    { name: "Ignacio Ludueña", age: 16, position: "DEL", club: "Instituto", image: "/images/ignacio-luduena.jpg", imagePosition: "70% 30%" },
    { name: "Kevin Garay", age: 20, position: "DEL", club: "Belgrano", image: "/images/kevin-garay.jpg" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <img src="/images/elite-sport-logo.png" alt="Elite Sport" className="h-9 w-auto" />
              <div className="w-2 h-2 rounded-full bg-[#C6A25D]" />
            </div>
